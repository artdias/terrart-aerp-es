...
export default function EditEscalaForm({
  allocation,
  funcionarios,
  clientes,
}: {
  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}>
        ...
        <h1 className={styles.title}>Editar Alocação / Escala</h1>
        <p className={styles.subtitle}>Modifique a tarefa, remuneração ou status do contrato.</p>
      </div>
        ...
        <form onSubmit={handleSubmit} className={styles.form}>
          ...
          <div className={styles.formRow}>
            <div className={styles.inputGroup}>
              ...
              <select id="employeeId" name="employeeId" required defaultValue={allocation.employeeId} style={{ padding: '0.95rem', borderRadius: '8px', border: '1px solid #ddd', background: '#fafafa' }}>
            ...
            <div className={styles.inputGroup}>
              ...
              <select id="clientId" name="clientId" required defaultValue={allocation.clientId} style={{ padding: '0.95rem', borderRadius: '8px', border: '1px solid #ddd', background: '#fafafa' }}>
          ...
          <h3 className={styles.sectionTitle}>Detalhes do Serviço & Status</h3>
          ...
          <div className={styles.formRow}>
            <div className={styles.inputGroup}>
              ...
              <input type="text" id="duration" name="duration" maxLength={100} defaultValue={allocation.duration || ""} placeholder="Ex: 8 horas diárias, 15 dias..." />
            </div>

            <div className={styles.inputGroup}>
              <label htmlFor="status">Status da Alocação <span style={{ color: '#e74c3c' }}>*</span></label>
              <select id="status" name="status" required defaultValue={allocation.status} style={{ padding: '0.95rem', borderRadius: '8px', border: '1px solid #ddd', background: '#fafafa' }}>
          ...
          <div className={styles.formRow}>
            <div className={styles.inputGroup}>
              ...
              <input type="number" step="0.01" id="paymentValue" name="paymentValue" required defaultValue={allocation.paymentValue} placeholder="Ex: 150.00" />
            </div>

            <div className={styles.inputGroup}>
              <label htmlFor="paymentFrequency">Base do Valor (Frequência) <span style={{ color: '#e74c3c' }}>*</span></label>
              <select id="paymentFrequency" name="paymentFrequency" required defaultValue={allocation.paymentFrequency} style={{ padding: '0.95rem', borderRadius: '8px', border: '1px solid #ddd', background: '#fafafa' }}>
